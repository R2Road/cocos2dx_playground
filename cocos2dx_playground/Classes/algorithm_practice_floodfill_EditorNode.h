...
namespace algorithm_practice_floodfill
{
	...
	private:
		EditorNode( const Config config, Grid4TileMap* const grid_4_tile_map, step_defender::game::TileMapNode* const tile_map_node, const cpg::TileSheetConfiguration& tile_sheet_configuration );

	public:
		static EditorNode* create( const Config config, Grid4TileMap* const grid_4_tile_map, step_defender::game::TileMapNode* const tile_map_node, const cpg::TileSheetConfiguration& tile_sheet_configuration );
