...
public:
	...
	ParticleFireworks* createWithTotalParticles( int numberOfParticles )
	{
		ParticleFireworks* ret = new ( std::nothrow ) ParticleFireworks();
...
namespace cocos_research_particle
{
	...
	bool BasicScene::init()
	{
		...
		//
		{
			auto particle_node = ParticleFireworks::create();
			particle_node->setPosition(
				visibleCenter.x
				, visibleOrigin.y + ( visibleSize.height * 0.25f )
			);
			addChild( particle_node );
		}
