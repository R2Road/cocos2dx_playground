...
namespace step_rain_of_chaos
{
	namespace game
	{
		class SpawnProcessor_SingleShot_02_TraceTarget : public iSpawnProcessor
		{
		private:
			SpawnProcessor_SingleShot_02_TraceTarget( const StageConfig& stage_config, const SpawnProcessorConfig& spawn_processor_config, const int repeat_count, const float sleep_per_cycle );
