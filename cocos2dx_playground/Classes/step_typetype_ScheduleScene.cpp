...
namespace step_typetype
{
	...
	bool ScheduleScene::init()
	{
		...
		//
		{
			mScheduleView_forUpdate.ViewLabel = Label::createWithTTF( "", cpg::StringTable::GetFontPath(), 12, Size::ZERO, TextHAlignment::CENTER );
		...
		//
		{
			mScheduleView_forCustomeUpdate.ViewLabel = Label::createWithTTF( "", cpg::StringTable::GetFontPath(), 12, Size::ZERO, TextHAlignment::CENTER );
		...
		//
		{
			mScheduleView_forLambda.ViewLabel = Label::createWithTTF( "", cpg::StringTable::GetFontPath(), 12, Size::ZERO, TextHAlignment::CENTER );
