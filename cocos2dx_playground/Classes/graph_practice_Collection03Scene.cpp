...
namespace graph_practice
{
	...
	bool Collection03Scene::init()
	{
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quartEase In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quartEaseIn( g_x ); } );
			graph_view_node->setPosition(
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quartEase Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quartEaseOut( g_x ); } );
			graph_view_node->setPosition(
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quartEase In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quartEaseInOut( g_x ); } );
			graph_view_node->setPosition(
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quintEase In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quintEaseIn( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin.x + ( visibleSize.width * ( StartRateX + ( SpacingX * 1 ) ) ) - ( graph_view_node->getContentSize().width * 0.5f )
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quintEase Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quintEaseOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin.x + ( visibleSize.width * ( StartRateX + ( SpacingX * 2 ) ) ) - ( graph_view_node->getContentSize().width * 0.5f )
				, visibleOrigin.y + ( visibleSize.height * ( StartRateY + ( SpacingY * 1 ) ) ) - ( graph_view_node->getContentSize().height * 0.5f )
			);
		...
		//
		{
			auto graph_view_node = GraphViewNode::create( "quintEase In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quintEaseInOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin.x + ( visibleSize.width * ( StartRateX + ( SpacingX * 3 ) ) ) - ( graph_view_node->getContentSize().width * 0.5f )
				, visibleOrigin.y + ( visibleSize.height * ( StartRateY + ( SpacingY * 1 ) ) ) - ( graph_view_node->getContentSize().height * 0.5f )
			);
