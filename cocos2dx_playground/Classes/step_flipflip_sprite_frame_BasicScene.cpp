...
namespace step_flipflip
{
	...
	{
		BasicScene::BasicScene() : mKeyboardListener( nullptr ), mTestNode( nullptr ) {}
		...
		bool BasicScene::init()
		{
			...
			//
			{
				...
				ss << std::endl;
				ss << std::endl;
				ss << "[A] : Change Sprite Frame : Card A";
				ss << std::endl;
				ss << "[S] : Change Sprite Frame : Card B";
		...
		void BasicScene::onKeyPressed( EventKeyboard::KeyCode keycode, Event* /*event*/ )
		{
			...
			{
				mTestNode->setSpriteFrame( "step_flipflip_card_front_0.png" );
			}

			if( EventKeyboard::KeyCode::KEY_S == keycode )
			{
				mTestNode->setSpriteFrame( "step_flipflip_card_front_1.png" );
			}
		}
	}
}
