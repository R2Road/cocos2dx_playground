...
namespace step_rain_of_chaos
{
	namespace game
	{
		...
		{
			SpawnProcessorUp ret( new ( std::nothrow ) SpawnProcessor_CircularSector_01_1Direction( stage_config, rotate_direction_left, degree_per_cycle, bullets_per_cycle, repeat_count, total_time ) );
			ret->init();
			return ret;
		}
